...
namespace Microsoft.BotBuilderSamples
{
    ...
    public class WelcomeUserBot : ActivityHandler
    {
            ...
            else
            {
                ...
                switch (text)
                {
                    ...
                    case "help":
                        ...
                        break;
                    case "vanilla":
                        await turnContext.SendActivityAsync("ICE ICE BABY");
                        break;
                    default:
        ...
        private static async Task SendIntroCardAsync(ITurnContext turnContext, CancellationToken cancellationToken)
        {
            ...
            card.Images = new List<CardImage>() { new CardImage("http://4.bp.blogspot.com/_CRgxs5OK7IM/TTnWMj-YZuI/AAAAAAAAADw/hN81R_W34Fk/s1600/waterboy_2.jpg") };
